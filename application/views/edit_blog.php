            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form id="add_new_blog" name="add_new_blog" class="form-horizontal"
                          action="<?php echo site_url('admin/update_blog'); ?>"
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                <fieldset>
                                    <legend class="text-semibold"><?php echo $blog_name; ?></legend>

                                <input type="hidden" name="blog_category" value="<?php echo $blog_name; ?>"/>
                                    <input type="hidden" name="blog_id" value="<?php echo $page_content->blog_id; ?>"/>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Blog Title:</label>

                                        <div class="col-lg-9">
                                            <input type="text" name="blog_title" id="blog_title"
                                                   value="<?php echo $page_content->blog_title; ?>"
                                                   class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="file" name="userfile" id="userfile"
                                                   value=""
                                                   class="form-control"
                                                   class="keyup-phone text-input"><?php if(!empty($page_content->blog_image)){  ?>
                                                <br>
                                                <img src="<?php echo base_url();?>assets/uploads/blogs/<?php echo $page_content->blog_image; ?>" width="250" height="150"/>
                                            <?php  }?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12">
                                            <textarea name="editor-full" id="editor-full" rows="4" cols="4" required>
                                                <?php echo $page_content->blog_content; ?>
                                            </textarea>
                                        </div>
                                    </div>
                                </fieldset>

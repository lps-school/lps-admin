            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form id="add_new_blog" name="add_new_blog" class="form-horizontal"
                          action="<?php echo site_url('admin/update_link'); ?>"
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                <fieldset>
                                    <legend class="text-semibold">Edit/Update Links</legend>

                                    <input type="hidden" name="link_id" value="<?php echo $link_content->id; ?>"/>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Title:</label>

                                        <div class="col-lg-9">
                                            <input type="text" name="link_title" id="link_title"
                                                   value="<?php echo $link_content->link_title; ?>"
                                                   class="form-control"

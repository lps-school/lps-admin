            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form id="add_new_blog" name="add_new_blog" class="form-horizontal"
                          action="<?php echo site_url('admin/update_news_events'); ?>"
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                <fieldset>
                                    <legend class="text-semibold">Edit/Update News & Events</legend>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="news_title" id="news_title"
                                                   value="<?php echo $news_content->news_title; ?>"
                                                   class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="file" name="userfile" id="userfile"
                                                   value=""
                                                   class="form-control"
                                                   class="keyup-phone text-input"><?php if(!empty($news_content->news_image)){  ?>
                                                <br>
                                                <img src="<?php echo base_url();?>assets/uploads/news_events/<?php echo $news_content->news_image; ?>" width="250" height="150"/>
                                            <?php  }?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-12">
                                            <textarea name="editor-full" id="editor-full" rows="4" cols="4" required>
                                                <?php echo $news_content->news_content; ?>
                                            </textarea>
                                        </div>
                                    </div>
                                </fieldset>

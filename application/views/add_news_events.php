            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form id="add_new_blog" name="add_new_blog" class="form-horizontal"
                          action="<?php echo site_url('admin/insert_news_events'); ?>"
                          method="post" enctype="multipart/form-data">
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h5 class="panel-title">Add News &  Events</h5>
                            ...
                            <div class="panel-body">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">News & Events Title:</label>

                                        <div class="col-lg-9">
                                            <input type="text" name="news_title" id="news_title"
                                                   value=""
                                                   class="form-control"
                                                   class="keyup-phone text-input" placeholder="News & Events Title" required="required">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">News & Events  Image:</label>
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">News & Events Content:</label>

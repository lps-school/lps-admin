            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form id="add_new_blog" name="add_new_blog" class="form-horizontal"
                          action="<?php echo site_url('admin/gallery_insert'); ?>"
                          method="post" enctype="multipart/form-data">
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h5 class="panel-title">Add New Image in Gallery</h5>
                            ...
                            <div class="panel-body">
                                <fieldset>
                                    <legend class="text-semibold"><code>important! =></code> Image Size must be <code>800 x 600</code> </legend>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="gallery_title" id="gallery_title"
                                                   value=""
                                                   class="form-control"
                                                   class="keyup-phone text-input" placeholder="Gallery Title" required="required">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Gallery Image:</label>

                                        <div class="col-lg-9">
                                            <input type="file" name="userfile" id="userfile"
                                                   value=""
                                                   class="form-control"
                                                   class="keyup-phone text-input" required="required">
                                        </div>
                                    </div>

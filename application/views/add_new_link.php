            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form id="add_new_blog" name="add_new_blog" class="form-horizontal"
                          action="<?php echo site_url('admin/link_insert'); ?>"
                          method="post" enctype="multipart/form-data">
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h5 class="panel-title">Add New Image for Create Link</h5>
                            ...
                            <div class="panel-body">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">File Title:</label>

                                        <div class="col-lg-9">
                                            <input type="text" name="link_title" id="link_title"
                                                   value=""
                                                   class="form-control"
                                                   class="keyup-phone text-input" placeholder="Link Title" required="required">
                                        </div>
                                    </div>

...
<script>
    ...
    function deleteFunction(id) {
       // alert('delete');
        if (confirm("Are you sure want to delete ?")) {
            ...
            //alert(dataString);
            $.ajax({
                url: '<?php echo base_url(); ?>admin/ajax_delete_news',
                type: 'post',
                data: dataString,
                success: function(response) {
                   ...
                   // alert(response);
                    ...
                    setTimeout(function() {
                        ...
                        window.location.href = "<?php echo base_url(); ?>admin/manage_news_events";
                    }, 5000 );
                },
                error: function() {
    ...
    function news_ajax_active_inactive(id,string){
        if(confirm('Are you Sure want to '+string+' this blog')){
            ...
            //alert(dataString);
            $.ajax({
                url: '<?php echo base_url(); ?>admin/news_ajax_active_inactive',
                type: 'post',
                data: dataString,
                success: function(response) {
...
<div class="panel-body">
    <a href="<?php echo site_url('admin/add_news_events') ?>" type="button" class="btn bg-teal">Add News & Events</a>
</div>
...
<tr>
    ...
    <td><?php echo substr($row['news_title'],0,25) ."...."; ?></td>
    <td><?php echo substr($row['news_content'],0,40) . "...."; ?></td>
    <td><img src="<?php echo base_url(); ?>assets/uploads/news_events/<?php if($row['news_image'] == '') echo "news-default.png"; else echo $row['news_image']; ?>" width="150" height="90"/> </td>
    <td><span class="label <?php if($row['news_status'] == 'Inactive') echo "label-danger"; else echo "label-success"; ?>"><?php echo $row['news_status']; ?></span></td>
        ...
        <ul class="icons-list">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <li onclick="news_ajax_active_inactive(<?php echo $row['news_id']; ?>,'Active');"><a href="#"><i class="icon-add"></i>Active</a></li>
                    <li onclick="news_ajax_active_inactive(<?php echo $row['news_id']; ?>,'Inactive');"><a href="#"><i class="icon-lock"></i>Inactive</a></li>
                    <li onclick="deleteFunction(<?php echo $row['news_id']; ?>);"><a href="#"><i class="icon-cross2"></i>Delete</a></li>
                    <li><a href="<?php echo site_url('admin/edit_news_events'."/".$row['news_id']); ?>"><i class="icon-database-edit2"></i>Edit</a></li>
                </ul>
            </li>
        </ul>
    </td>

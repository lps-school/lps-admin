            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form id="add_new_blog" name="add_new_blog" class="form-horizontal"
                          action="<?php echo site_url('admin/insert_blogs'); ?>"
                        ...
                        <div class="panel panel-flat">
                            ...
                            <div class="panel-body">
                                <fieldset>
                                    <legend class="text-semibold"><code>important! =></code> Image Size Should be <code>800 x 350</code> </legend>


                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Choose Blog Categories</label>

                                        <div class="col-lg-9">
                                            <select name="blog_category" id="blog_category" class="select" required="required">
                                                <option value="kindergarten_blog">Kindergarten Blog</option>
                                                <option value="Class_2_3_blogs">Class II & III Blogs</option>
                                                <option value="Class_4_5_6_blogs">Class IV, V & VI Blogs</option>
                                                <option value="lead_on_blog">Lead On Blog</option>
                                                <option value="library_blog">Library Blog</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="file" name="userfile" id="userfile"
                                                   value=""
                                                   class="form-control"
                                                   class="keyup-phone text-input">
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Blog Content:</label>

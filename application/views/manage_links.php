...
<script>
    ...
    function deleteFunction(id) {
       // alert('delete');
        if (confirm("Are you sure want to delete ?")) {
            ...
            //alert(dataString);
            $.ajax({
                url: '<?php echo base_url(); ?>admin/ajax_delete_link',
                type: 'post',
                data: dataString,
                success: function(response) {
                   ...
                   // alert(response);
                    ...
                    setTimeout(function() {
                        ...
                        window.location.href = "<?php echo base_url(); ?>admin/manage_links";
                    }, 5000 );
                },
                error: function() {
    ...
    function link_ajax_active_inactive(id,string){
        if(confirm('Are you Sure want to '+string+' this blog')){
            ...
            //alert(dataString);
            $.ajax({
                url: '<?php echo base_url(); ?>admin/link_ajax_active_inactive',
                type: 'post',
                data: dataString,
                success: function(response) {
...
<div class="panel-body">
    <a href="<?php echo site_url('admin/add_new_link') ?>" type="button" class="btn bg-teal">Add New Link</a>
</div>
...
<tr>
    <td><?php echo $i; ?></td>
    <td><?php echo substr($row['link_title'],0,50) ."..."; ?></td>
        ...
        <ul class="icons-list">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <li onclick="link_ajax_active_inactive(<?php echo $row['id']; ?>,'Active');"><a href="#"><i class="icon-add"></i>Active</a></li>
                    <li onclick="link_ajax_active_inactive(<?php echo $row['id']; ?>,'Inactive');"><a href="#"><i class="icon-lock"></i>Inactive</a></li>
                    <li onclick="deleteFunction(<?php echo $row['id']; ?>);"><a href="#"><i class="icon-cross2"></i>Delete</a></li>
                    <li><a href="<?php echo site_url('admin/edit_link'."/".$row['id']); ?>"><i class="icon-database-edit2"></i>Edit</a></li>
                </ul>
            </li>
        </ul>
    </td>

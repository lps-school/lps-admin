...
<script>
    ...
    function deleteFunction(id) {
       // alert('delete');
        if (confirm("Are you sure want to delete ?")) {
            ...
            //alert(dataString);
            $.ajax({
                url: '<?php echo base_url(); ?>admin/ajax_delete_gallery',
                type: 'post',
                data: dataString,
                success: function(response) {
                   ...
                   // alert(response);
                    ...
                    setTimeout(function() {
                        ...
                        window.location.href = "<?php echo base_url(); ?>admin/manage_gallery";
                    }, 5000 );
                },
                error: function() {
    ...
    function gallery_ajax_active_inactive(id,string){
        if(confirm('Are you Sure want to '+string+' this blog')){
            ...
            //alert(dataString);
            $.ajax({
                url: '<?php echo base_url(); ?>admin/gallery_ajax_active_inactive',
                type: 'post',
                data: dataString,
                success: function(response) {
...
<div class="content-wrapper">
    <div id="success_msg" class="alert alert-success alert-styled-left alert-arrow-left alert-bordered">
        ...
        <span class="text-semibold">Well done!</span> You are successfully Update the Gallery. for updation Page will redirect in 5 seconds!
    </div>
...
<div class="panel-body">
    <a href="<?php echo site_url('admin/gallery_upload') ?>" type="button" class="btn bg-teal">Add Gallery</a>
</div>
...
<tbody>
<?php foreach($gallery_content as  $row){ ?>
<tr>
    <td><?php echo $row['gallery_id']; ?></td>
    <td><?php echo substr($row['gallery_title'],0,25) ."...."; ?></td>
    <td><img src="<?php echo base_url(); ?>assets/uploads/gallery/<?php  echo $row['gallery_image']; ?>" width="200" height="120"/> </td>
        ...
        <ul class="icons-list">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <li onclick="gallery_ajax_active_inactive(<?php echo $row['gallery_id']; ?>,'Active');"><a href="#"><i class="icon-add"></i>Active</a></li>
                    <li onclick="gallery_ajax_active_inactive(<?php echo $row['gallery_id']; ?>,'Inactive');"><a href="#"><i class="icon-lock"></i>Inactive</a></li>
                    <li onclick="deleteFunction(<?php echo $row['gallery_id']; ?>);"><a href="#"><i class="icon-cross2"></i>Delete</a></li>
                    <li><a href="<?php echo site_url('admin/edit_gallery'."/".$row['gallery_id']); ?>"><i class="icon-database-edit2"></i>Edit</a></li>
                </ul>
            </li>
        </ul>
    </td>

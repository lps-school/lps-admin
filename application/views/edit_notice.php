            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form id="add_new_blog" name="add_new_blog" class="form-horizontal"
                          action="<?php echo site_url('admin/update_notice'); ?>"
                          method="post" enctype="multipart/form-data">
                        <input type="hidden" name="notice_id" value="<?php echo $notice_content->id; ?>"/>
                        <div class="panel panel-flat">
                            <div class="panel-heading">
                                <h5 class="panel-title">Edit Notice</h5>
                            ...
                            <div class="panel-body">
                                <fieldset>
                                    <legend class="text-semibold"><code>important! =></code> All Fields are<code>required!</code> </legend>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="notice_title" id="notice_title"
                                                   value="<?php echo $notice_content->title;  ?>"
                                                   class="form-control"
                                                   class="keyup-phone text-input" placeholder="Notice Title" required="required">
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Notice Text:</label>

                                        <div class="col-lg-12">
                                            <textarea name="editor-full" id="editor-full" rows="4" cols="4" required><?php echo $notice_content->notice;  ?></textarea>
                                        </div>
                                    </div>
                                </fieldset>

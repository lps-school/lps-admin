...
(function () {
        ...
        return {
            define: function (b, f) {
                ...
                if (m.getListenerIndex(f) < 0) {
                    ...
                    i.fn = f;
                    i.priority = l;
                    for (var s = m.length - 1; s >= 0; s--)if (m[s].priority <= l) {
                        m.splice(s + 1, 0, i);
            ...
            once: function () {
                ...
                return function (l, i, g) {
                    ...
                    if (m) {
                        var s = m.listeners;
                        if (s.length)for (var s = s.slice(0), y, p = 0; p < s.length; p++) {
                            if (m.errorProof)try {
                                y =
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, e = function (a, f) {
            ...
            table: 1,
            ul: 1
        }, d = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, l = {"#": 1}, i = {
            center: 1,
            dir: 1,
            noframes: 1
        };
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        appendTo: function (a, e) {
            ...
            do if (!a || !(b != this.$ && b.nodeType == CKEDITOR.NODE_TEXT && (f || !b.nodeValue))) {
                c++;
            ...
            for (var e = this.getAddress(), a = a.getAddress(),
                     b = Math.min(e.length, a.length), c = 0; c <= b - 1; c++)if (e[c] != a[c]) {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) {
            ...
            for (var b =
                ...
                var f = a[c];
                if (e)for (var d = -1, h = 0; h < b.childNodes.length; h++) {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeStyle: function (a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], i = 0; i < c.length; i++)if (e)for (var g = 0; g < e.length; g++)b.push([a, c[i], e[g]].join("-")); else b.push([a, c[i]].join("-"));
    ...
    (function () {
        function a(a, b) {
            ...
            if (this.current)d = this.current[n](false, k, h); else {
                if (a)d.type ==
                CKEDITOR.NODE_ELEMENT && (d = e > 0 ? d.getChild(e - 1) : h(d, true) === false ? null : d.getPreviousSourceNode(true, k, h)); else {
                    d = f;
    ...
    (function () {
        ...
        var c = function (a) {
            ...
            else if (e.getChildCount() > 0)if (u >= e.getChildCount()) {
            ...
            } else if (j)if (j >= f.getChildCount()) {
                f = f.append(a.document.createText(""));
                h = true
            } else f = f.getChild(j).getPrevious(); else {
            ...
            for (var o = c, i, D, l, z = k; z < j.length; z++) {
                ...
                for (i = i.getNext(); i;) {
                    ...
                    l = i.getNext();
                    if (b == 2)o.append(i.clone(true)); else {
                        i.remove();
                        b == 1 && o.append(i)
                    }
                    i = l
            ...
            for (c = k; c < u.length; c++) {
                ...
                if (!j[c] || i.$.parentNode != j[c].$.parentNode)for (i = i.getPrevious(); i;) {
                    if (i.equals(j[c]) || i.equals(f))break;
                    l = i.getPrevious();
                    if (b == 2)o.$.insertBefore(i.$.cloneNode(true), o.$.firstChild); else {
                        i.remove();
        ...
        CKEDITOR.dom.range.prototype =
        {
            ...
            return function (b) {
                var c = this.collapsed,
                    d = {container: this.startContainer, offset: this.startOffset}, f = {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    for (g = c(g); g || k;) {
                        ...
                        for (; k;) {
                            o =
                                false;
                            if (k.type == CKEDITOR.NODE_COMMENT)k = k.getPrevious(); else {
                                if (k.type == CKEDITOR.NODE_TEXT) {
                                    l = k.getText();
                                    d.test(l) && (k = null);
                                    o = /[\s\ufeff]$/.test(l)
                                } else if ((k.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && k.is("br")) && !k.data("cke-bookmark"))if (r && CKEDITOR.dtd.$removeEmpty[k.getName()]) {
                                    l = k.getText();
                                    if (d.test(l))k = null; else for (var D = k.$.getElementsByTagName("*"), J = 0, z; z = D[J++];)if (!CKEDITOR.dtd.$removeEmpty[z.nodeName.toLowerCase()]) {
                                        k = null;
                                        break
                                    }
                                    k && (o = !!l.length)
                    ...
                    if (o.type == CKEDITOR.NODE_TEXT)if (CKEDITOR.tools.trim(o.substring(D)).length)r = true; else {
                        r = !o.getLength();
                        if (D == o.getLength()) {
                    ...
                    for (; g || k;) {
                        ...
                        for (; k;) {
                            ...
                            if (k.type == CKEDITOR.NODE_TEXT) {
                                ...
                                if ((k.$.offsetWidth > 0 || b && k.is("br")) && !k.data("cke-bookmark"))if (r && CKEDITOR.dtd.$removeEmpty[k.getName()]) {
                                    l = k.getText();
                                    if (d.test(l))k = null; else {
                                        D = k.$.getElementsByTagName("*");
                                        for (J = 0; z = D[J++];)if (!CKEDITOR.dtd.$removeEmpty[z.nodeName.toLowerCase()]) {
                                            k = null;
                                            break
                                        }
                                    }
            ...
            if (!this.collapsed) {
                var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), f = this.startContainer, e = this.endContainer,
                    j = this.startOffset, g = this.endOffset, h = 1, i = 1;
                if (f && f.type == CKEDITOR.NODE_TEXT)if (j)if (j >= f.getLength())d.setStartAfter(f); else {
                    d.setStartBefore(f);
                    h = 0
    ...
    (function () {
        ...
        var f = /^[\r\n\t ]+$/, d = CKEDITOR.dom.walker.bookmark(false, true),
            h = CKEDITOR.dom.walker.whitespaces(true), l = function (a) {
                return d(a) && h(a)
            }, i = {dd: 1, dt: 1, li: 1};
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                for (this._.nextNode = null; j;) {
                    ...
                    (E = 0); else {
                        ...
                        if (CKEDITOR.dtd.$block[n] && j.getAttribute("contenteditable") == "false") {
                            ...
                            if (n == "br")E = 1; else if (!h && !j.getChildCount() && n != "hr") {
                                e = j;
                                s = j.equals(q);
                                break
                            }
                ...
                if (!e) {
                    ...
                    u = {div: 1, th: 1, td: 1};
                    e = e.block;
                    if (!e && j && !this.enforceRealBlocks && u[j.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !j.equals(h.root))e = j; else if (!e || this.enforceRealBlocks && e.is(i)) {
    ...
    (function () {
        function a(a, b, c, d, f) {
            ...
            for (var b = f.elements, f = f.generic, D, c = 0, d = a.length; c < d; ++c) {
                ...
                if (e.elements === true || e.elements === null)f[n ? "unshift" : "push"](e); else {
                    j = e.elements;
                    delete e.elements;
                    for (D in j)if (b[D])b[D][n ? "unshift" : "push"](e); else b[D] = [e]
                }
            }
        }
        ...
        function y(a, b, d, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) {
                a:for (var x = a.elementCallbacks, h = 0, o = x.length, w; h < o; ++h)if (w = x[h](b)) {
                    r = w;
                    break a
                }
                if (r)return r
            }
            if (f.doTransform)if (r = a._.transformations[b.name]) {
                s(b);
            ...
            if (f.doFilter) {
                a:{
                    ...
                    if (!a && !r)a = null; else {
                        ...
                        if (x) {
                            p = 0;
                            for (g = x.length; p < g; ++p)if (c(x[p], b, w) === false) {
                                a = null;
                                break a
                            }
                        }
                ...
                if (!a.allAttributes)for (u in x)if (!g[u])if (v.test(u)) {
        ...
        function k(a, b, c) {
            var d = a.name;
            if (J.$empty[d] || !a.children.length)if (d == "hr" && b == "br")a.replaceWith(v()); else {
                a.parent && c.push({check: "it", el: a.parent});
                a.remove()
            } else if (J.$block[d] || d == "tr")if (b == "br") {
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || !(a.name == "span" && ~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))) {
                            r = y(f,
                                a, e, h);
                            if (r & z)x = true; else if (r & 2)return false
                        }
                        ...
                        a:{
                            ...
                            c = [];
                            var j, k, o;
                            if (n)for (k = 0; k < n.length; ++k)if ((o = d.match(n[k])) && o[0].length == d.length) {
                                c = true;
                                break a
                            }
        ...
        var C = {styles: 1, attributes: 1, classes: 1}, A = {
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, e) {
            ...
            CKEDITOR.scriptLoader.load(d, function (a, d) {
                ...
                for (var f = 0; f < a.length; f++)for (var p = h[a[f]], g = 0; g < p.length; g++) {
                    var j = p[g];
                    l[j] = this.get(j);
                    c[j] = 1
                }
        ...
        function m(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                for (var j in c) {
                    ...
                    if (u && (w = u.match(k)))for (; u = w.pop();)CKEDITOR.tools.setTimeout(function (a, b) {
                    ...
                    if (g && !a.lang[j]) {
                        ...
                        if (!h.langEntries || !h.langEntries[i])e.push(CKEDITOR.getUrl(h.path + "lang/" + i + ".js")); else {
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (d, h, l) {
                function i(a) {
                    var b;
                    if (j.length > 0)for (var c = 0; c < j.length; c++) {
                ...
                p.onTagOpen = function (d, f, h, l) {
                    ...
                    if (f.isUnknown && h)f.isEmpty =
                        true;
                    f.isOptionalClose = l;
                    if (a(f))j.push(f); else {
                        if (d == "pre")k = true; else {
                            if (d == "br" && k) {
                        ...
                        if (d == "br")u.push(f); else {
                            for (; ;) {
                                l = (h = v.name) ? CKEDITOR.dtd[h] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                                if (!f.isUnknown && !v.isUnknown && !l[d])if (v.isOptionalClose)p.onTagClose(h); else if (d in b && h in b) {
                                    h = v.children;
                                    (h = h[h.length - 1]) && h.name == "li" || t(h = new CKEDITOR.htmlParser.element("li"), v);
                                    !f.returnPoint && (f.returnPoint = v);
                                    v = h
                                } else if (d in CKEDITOR.dtd.$listItem && !y(d, h))p.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1); else if (h in e && !y(d, h)) {
                                    !f.returnPoint && (f.returnPoint = v);
                                    v = v.parent
                                } else {
                                    h in CKEDITOR.dtd.$inline && j.unshift(v);
                                    if (v.parent)t(v, v.parent, 1); else {
                                        f.isOrphan = 1;
                                        break
                                    }
                                } else break
                ...
                p.onTagClose = function (a) {
                    for (var b = j.length - 1; b >= 0; b--)if (a == j[b].name) {
                        j.splice(b, 1);
                        return
                    }
    ...
    (function () {
            ...
            function r(a, f) {
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var j = [], k = b(e), x, r;
                        if (k)for (w(k, 1) && j.push(k); k;) {
                            if (d(k) && (x = c(k)) && w(x))if ((r = c(x)) && !d(r))j.push(x); else {
                                n(o).insertAfter(x);
                                x.remove()
                            }
                            k = k.previous
                        ...
                        if (j = (typeof f == "function" ? f(e) : f) !== false)if (!o && !CKEDITOR.env.needsBrFiller &&
                            e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)j = false; else if (!o && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem))j = false; else {
                            j = b(e);
        ...
        var j = /(?:&nbsp;|\xa0)$/, u = "{cke_protected}", v = CKEDITOR.dtd, E = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], k = CKEDITOR.tools.extend({}, v.$blockLimit, v.$block), n = {
            elements: {
                input: l,
                textarea: l
            }
        ...
        var D = /<(a|area|img|input|source)\b([^>]*)>/gi, J = /([\w-]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, z = /^(href|src|name)$/i, L = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, B = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, w = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, H = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                for (i in e) {
                    g = i;
                    for (l = e[i]; ;)if (g = a.onAttributeName(b, i))if (g != i) {
                        delete e[i];
                        i = g
                    } else break; else {
                        delete e[i];
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, d = a.element, e = a.elementMode,
                l = a.fire("uiSpace", {space: "top", html: ""}).html, i = a.fire("uiSpace", {
                    space: "bottom",
                    html: ""
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    var r, g;
                    if (f)for (; (r = b.getCommonAncestor(0, 1)) && (g = CKEDITOR.dtd[r.getName()]) && (!g || !g[e]);)if (r.getName()in
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                            ...
                            if (b in k) {
                                ...
                                if (d.collapsed) {
                                    ...
                                    e = b.block;
                                    i = c.endPath().block;
                                    if (!e || !i || e.equals(i))b = false; else {
                                        a.fire("saveSnapshot");
        ...
        var p = function () {
            ...
            function b(c, d) {
                ...
                for (var i = g[i.getName()], o = 0, l = c.getChildren(), m = l.count(), D = -1, p = -1, M = 0, s = e.contains(g.$list); o < m; ++o) {
                    ...
                    if (a(e)) {
                        k = e.getName();
                        if (s && k in CKEDITOR.dtd.$list)h = h.concat(b(e, d)); else {
                            n = !!i[k];
            ...
            var g = CKEDITOR.dtd, o = {
                ...
                dl: 1,
                blockquote: 1
            }, l = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, m = CKEDITOR.tools.extend({}, g.$inline);
            delete m.br;
                    ...
                    if (A) {
                        ...
                        for (n(x, t); A < x.length; A++) {
                            ...
                            if (q = F.isLineBreak) {
                                ...
                                if (F.hasBlockSibling)q = 1; else {
                                    P = q.startContainer.getAscendant(g.$block, 1);
                                    if (!P || !P.is({div: 1, p: 1}))q = 0; else {
                                        V = P.getPosition(N);
                                        if (V == CKEDITOR.POSITION_IDENTICAL || V == CKEDITOR.POSITION_CONTAINS)q = 0; else {
                                            N = q.splitElement(P);
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            d.on("contentDom", function () {
                ...
                CKEDITOR.env.gecko && k.attachListener(k, "focus", function (a) {
                    a.removeListener();
                    if (j !== 0)if ((a = d.getSelection().getNative()) && a.isCollapsed && a.anchorNode == k.$) {
                        a = d.createRange();
            ...
            var a = u ? function () {
                ...
                var b = function (b, c) {
                    ...
                    for (var e = d.children, f, g, h = b.duplicate(), k = 0, i = e.length - 1, j = -1, A, x; k <= i;) {
                        ...
                        if (A > 0)i = j - 1; else if (A < 0)k = j + 1; else return {container: d, offset: a(f)}
                    }
    ...
    (function () {
            ...
            if (b.collapsed) {
                ...
                for (o.getPosition(p) == CKEDITOR.POSITION_FOLLOWING && (o = 0); o;) {
                    ...
                    if (o.equals(p)) {
                        ...
                        if (t && k && CKEDITOR.dtd.$block[s])for (var v = o, u = c(v), z = void 0, D = u.length, E = 0, v = D && new CKEDITOR.dom.range(v.getDocument()); E < D; ++E) {
                        ...
                        if (u)if ((u = o.getParent()) && ((u.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(u))) {
        ...
        function s(a, b) {
            var c = this._.definition,
                d = c.attributes, c = c.styles, e = E(this)[a.getName()], f = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), g;
            for (g in d)if (!((g == "class" || this._.definition.fullMatch) && a.getAttribute(g) != k(g, d[g])) && !(b && g.slice(0, 5) == "data-")) {
                f = a.hasAttribute(g);
                a.removeAttribute(g)
            }
            for (var h in c)if (!(this._.definition.fullMatch && a.getStyle(h) != k(h, c[h], true))) {
                f = f || !!a.getStyle(h);
                a.removeStyle(h)
            }
            p(a, e, r[a.getName()]);
                ...
                return {
                    getNextRange: function (h) {
                        ...
                        if (l && a.length > 1) {
                            ...
                            if (h)for (var g = 0; a[d + g + 1];) {
                                for (var m = l.document, h = 0, i = m.getById(e[g].endNode), m = m.getById(e[g +
                                1].startNode); ;) {
                                    i = i.getNextSourceNode(false);
                                    if (m.equals(i))h = 1; else if (c(i) || i.type == CKEDITOR.NODE_ELEMENT && i.isBlockBoundary())continue;
                                    break
                                }
                                if (!h)break;
                                g++
    ...
    CKEDITOR.plugins.add("pbckcode", {
        icons: "pbckcode", lang: ["fr", "en"], init: function (a) {
            var b = this;
            ...
            a.ui.addButton("pbckcode", {label: a.lang.pbckcode.addCode, command: commandName, toolbar: "pbckcode"});
            a.addCommand(commandName, new CKEDITOR.dialogCommand("pbckcodeDialog", {allowedContent: "pre[*]{*}(*)"}));
            ...
            a.contextMenu && (a.addMenuGroup("pbckcodeGroup"), a.addMenuItem("pbckcodeItem", {
                ...
                if (a.getAscendant("pre",
                        true))return {pbckcodeItem: CKEDITOR.TRISTATE_OFF}
            }));
    ...
    (function () {
        ...
        if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,blockquote,168,,copy-rtl,192,,copy,216,,cut-rtl,240,,cut,264,,paste-rtl,288,,paste,312,,horizontalrule,336,,image,360,,indent-rtl,384,,indent,408,,outdent-rtl,432,,outdent,456,,anchor-rtl,480,,anchor,504,,link,528,,unlink,552,,bulletedlist-rtl,576,,bulletedlist,600,,numberedlist-rtl,624,,numberedlist,648,,maximize,672,,pastetext-rtl,696,,pastetext,720,,pastefromword-rtl,744,,pastefromword,768,,removeformat,792,,source-rtl,816,,source,840,,specialchar,864,,scayt,888,,table,912,,redo-rtl,936,,redo,960,,undo-rtl,984,,undo,1008,,spellchecker,1032,,pbckcode,2112,auto', 'icons_hidpi.png'); else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,blockquote,168,auto,copy-rtl,192,auto,copy,216,auto,cut-rtl,240,auto,cut,264,auto,paste-rtl,288,auto,paste,312,auto,horizontalrule,336,auto,image,360,auto,indent-rtl,384,auto,indent,408,auto,outdent-rtl,432,auto,outdent,456,auto,anchor-rtl,480,auto,anchor,504,auto,link,528,auto,unlink,552,auto,bulletedlist-rtl,576,auto,bulletedlist,600,auto,numberedlist-rtl,624,auto,numberedlist,648,auto,maximize,672,auto,pastetext-rtl,696,auto,pastetext,720,auto,pastefromword-rtl,744,auto,pastefromword,768,auto,removeformat,792,auto,source-rtl,816,auto,source,840,auto,specialchar,864,auto,scayt,888,auto,table,912,auto,redo-rtl,936,auto,redo,960,auto,undo-rtl,984,auto,undo,1008,auto,spellchecker,1032,auto,pbckcode,1056,auto', 'icons.png');
    })();
